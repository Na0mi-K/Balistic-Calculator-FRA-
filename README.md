...
En pratique, pour des projectiles dans l’air avec résistance linéaire (modèle idéalisé, valable plutôt à faible nombre de Reynolds), 
α est souvent petit, donc sur la durée typique de vol, αt peut rester dans un domaine où l’ordre 4 est excellent
Mais on peut Augmenter l’ordre du développement (5, 6, …) jusqu’à ce que le terme suivant soit négligeable
